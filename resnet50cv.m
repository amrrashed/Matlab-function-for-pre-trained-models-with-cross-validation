function [t,x] = resnet50cv(path,optimizer,augmentation,numfold)
...
%     % Data Augumentation
    ...
    %save(sprintf('ResNet50_%d_among_%d_folds',fold_idx,num_folds),'netTransfer','test_idx','train_idx','labeltest','labeltrain');
    delete(findall(0))
